...
/*
    sumtables-oddstates-benchmark.c

    This test is analogous to `sumtables` but using an odd number of states
...
int main(int argc, char *argv[]) {
  ...
  for (k = 0; k < NUM_CATS; ++k) {
    ...
    double subst_params[10] = {1.452176, 0.937951, 0.462880, 0.617729, 1.745312, 0.937951, 0.462880, 0.617729, 1.745312,
                               1.000000};
