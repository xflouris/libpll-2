...
#define MM_DAZ_ON    0x0040
    ...
    if (common_args->n_benchmark_repeat > 1) {
        printf("Round,"
               "Seed,"
               "n_sites,"
               "n_categories,"
    ...
    for (size_t r = 0; r < common_args->n_benchmark_repeat; r++) {
        ...
        float avx2sml_aa_secs = benchmark_kernel(n_tips, align_aa, pll_aa_freqs_dayhoff, pll_aa_rates_dayhoff,
                                                 pll_map_aa,
                                                 20, common_args, operations,
        ...
        float avx512_aa_secs = benchmark_kernel(n_tips, align_aa, pll_aa_freqs_dayhoff, pll_aa_rates_dayhoff,
                                                pll_map_aa,
                                                20, common_args, operations,
                                                &pll_core_update_partial_ii_20x20_avx512f,
                                                PLL_ATTRIB_ARCH_CPU | PLL_ATTRIB_ARCH_AVX512F);

        float avx512sml_aa_secs = benchmark_kernel(n_tips, align_aa, pll_aa_freqs_dayhoff, pll_aa_rates_dayhoff,
                                                   pll_map_aa,
                                                   20, common_args, operations,
        ...
        float avx2sml_nt_secs = benchmark_kernel(n_tips, align_nt, pll_nt_freqs, pll_nt_rates, pll_map_nt, 4,
                                                 common_args,
                                                 operations,
        ...
        float avx512sml_nt_secs = benchmark_kernel(n_tips, align_nt, pll_nt_freqs, pll_nt_rates, pll_map_nt, 4,
                                                   common_args,
                                                   operations,
        ...
        if (common_args->n_benchmark_repeat > 1) {
            ...
            printf("%zu,%d,%d,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n",
                   r+1,
                   common_args->seed,
                   n_sites,
                   n_categories,
                   common_args->n_itr,
                   common_args->pinvar,
                   common_args->n_sites * common_args->n_categories * 20 * sizeof(double) / 1024.0,
                   common_args->n_sites * common_args->n_categories * 4 * sizeof(double) / 1024.0,
                   avx2_aa_secs,
                   avx2sml_aa_secs,
                   avx512_aa_secs,
                   avx512sml_aa_secs,
