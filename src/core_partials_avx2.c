...
PLL_EXPORT void pll_core_update_partial_ii_16x16_avx2(unsigned int sites,
                                                unsigned int rate_cats,
                                                double * parent_clv,
                                                unsigned int * parent_scaler,
                                                const double * left_clv,
                                                ...
                                                unsigned int attrib)
{
  ...
  {
    pll_core_update_partial_ii_16x16_avx2(sites,
                                       rate_cats,
                                       parent_clv,
                                       parent_scaler,
                                       left_clv,
...
PLL_EXPORT void pll_core_update_partial_repeats_16x16_avx2(unsigned int parent_sites,
                                                             ...
                                                             unsigned int attrib)
{
  ...
  if (states == 16)
  {
    return pll_core_update_partial_repeats_16x16_avx2(parent_sites,
                                                      left_sites,
                                                      right_sites,
                                                      rate_cats,
                                                      parent_clv,
